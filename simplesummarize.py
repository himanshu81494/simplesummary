#!/usr/bin/env python
# Himanshu Gautam
# A simple extraction based summary generator for news feeds and articles
# uses python3
# this scripts can be uses as webscrapper using BeautifulSoup or simple function call providing text to be summarized
...
def is_unimportant(word):
    ...
    #print (word)
    return word in ['.', '!', ',', '?', ':', '\'s', 'n\'t'] or '\'' in word or word.lower() in stop_words
